...
import com.example.output.json.CityJsonWriter;
...
public class ApplicationLab {
    ...
    private static CollectionInput getCollectionInput(CollectionRepository collectionRepository) {
        ...
        IEnvironmentProvider environmentProvider = new EnvVariableProvider("CITY_FILE");
        IJsonWriter<List<CityForJsonDto>> fileWriter = new CityJsonWriter();
        IInputStreamProvider inputStreamProvider = new FileInputStreamProvider();
        IJsonParser<List<CityFromJsonDto>> parser = new CityJsonParser();
